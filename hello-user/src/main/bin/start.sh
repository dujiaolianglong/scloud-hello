...
#debug Options
JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8071,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.lxl.hello.user.HelloUserAppStarter"
...
if [ $? -ne 0 ];then
	echo "--------------------------hello-user server start fail-----------------------------------"
else
	echo "--------------------------hello-user server start success-----------------------------------"
fi
#==============================================================================
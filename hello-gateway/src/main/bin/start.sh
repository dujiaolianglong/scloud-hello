...
#debug Options
JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8069,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.lxl.hello.gateway.HelloGatewayAppStarter"
...
if [ $? -ne 0 ];then
	echo "--------------------------hello-gateway server start fail-----------------------------------"
else
	echo "--------------------------hello-gateway server start success-----------------------------------"
fi
#==============================================================================
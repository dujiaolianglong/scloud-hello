...
#debug Options
JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8067,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.lxl.hello.discovery.HelloDiscoveryAppStarter"
...
if [ $? -ne 0 ];then
	echo "--------------------------hello-discovery server start fail-----------------------------------"
else
	echo "--------------------------hello-discovery server start success-----------------------------------"
fi
#==============================================================================
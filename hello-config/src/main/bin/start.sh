...
#debug Options
JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8068,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.lxl.hello.config.HelloConfigAppStarter"
...
if [ $? -ne 0 ];then
	echo "--------------------------hello-config server start fail-----------------------------------"
else
	echo "--------------------------hello-config server start success-----------------------------------"
fi
#==============================================================================
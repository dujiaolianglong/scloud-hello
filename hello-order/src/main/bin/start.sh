...
#debug Options
JAVA_OPTS="$JAVA_OPTS -Xdebug -Xrunjdwp:transport=dt_socket,address=8070,server=y,suspend=n"
#==============================================================================
...
RUN_CMD="$RUN_CMD com.lxl.hello.order.HelloOrderAppStarter"
...
if [ $? -ne 0 ];then
	echo "--------------------------hello-order server start fail-----------------------------------"
else
	echo "--------------------------hello-order server start success-----------------------------------"
fi
#==============================================================================